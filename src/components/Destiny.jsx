const Destiny = () => {
  return(
    <>
      <div className="container mx-auto flex flex-col items-center justify-center py-21">
        
        <h2 className="text-center text-5xl mb-9 text-white font-bold">Ready to Discover Your <span className="text-yellow-500">Destiny</span> ?</h2>
